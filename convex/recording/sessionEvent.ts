...
export const recordingSessionEventPayload = v.union(
  v.object({
  ...
  v.object({
    kind: v.literal("note-delete"),
    id: v.string(),
    from: v.optional(v.string()),
  }),
  v.object({
    kind: v.literal("segment-start"),
    segment,
    from: v.optional(v.string()),
  }),
  v.object({
  ...
  v.object({
    kind: v.literal("segment-delete"),
    id: v.string(),
    from: v.optional(v.string()),
  }),
  v.object({
    kind: v.literal("edit-cue"),
    cue: editCue,
    from: v.optional(v.string()),
  }),
  v.object({
  ...
  v.object({
    kind: v.literal("edit-cue-delete"),
    id: v.string(),
    from: v.optional(v.string()),
  }),
  v.object({
