...
export type PublicApiType = {
    ...
    assignments: {
        admin: {
            ...
            getWorkbench: FunctionReference<"query", "public", {
                id: Id<"assignments">;
            }, {
                assignment: {
                    episode: {
            ...
            removeAudioMessage: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
                expected: {
                    assignmentId: Id<"assignments"> | null;
                    createdAt: number;
            ...
            setPlayable: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
        ...
        public: {
            createMyAudioMessage: FunctionReference<"mutation", "public", {
                assignmentId: Id<"assignments">;
                clientApiVersion: string;
                createdAt: number;
                fileKey: string;
            ...
            deleteMyAudioMessage: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
                id: Id<"assignmentAudioMessages">;
            }, {
                id: Id<"assignmentAudioMessages">;
            }>;
            discardMyAudioUpload: FunctionReference<"mutation", "public", {
                assignmentId: Id<"assignments">;
                clientApiVersion: string;
                fileKey: string;
                uploadId: string;
            ...
            listMyAudioMessages: FunctionReference<"query", "public", {
                assignmentId: Id<"assignments">;
            }, Array<{
                createdAt: number;
                fileKey: string | null;
    ...
    catalog: {
        admin: {
            ...
            getMovieDetail: FunctionReference<"query", "public", {
                id: Id<"movies">;
            }, {
                media: {
                    id: Id<"movies">;
            ...
            getShowDetail: FunctionReference<"query", "public", {
                id: Id<"shows">;
            }, {
                media: {
                    id: Id<"shows">;
    ...
    episodes: {
        ...
        admin: {
            ...
            previewDuplicateMerge: FunctionReference<"query", "public", {
            ...
            mergeDuplicateEpisode: FunctionReference<"mutation", "public", {
                keeperId: Id<"episodes">;
                donorId: Id<"episodes">;
        ...
        audio: {
            ...
            discardMyUpload: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
                episodeId: Id<"episodes">;
                fileKey: string;
                uploadId: string;
    ...
    games: {
        ...
        member: {
            ...
            mySeasonOverview: FunctionReference<"query", "public", {
                seasonId: Id<"seasons">;
                today: string;
            }, {
                available: number;
            ...
            mySeasonPointsPage: FunctionReference<"query", "public", {
                paginationOpts: {
                    cursor: string | null;
                    endCursor?: string | null;
                    id?: number;
            ...
            mySeasons: FunctionReference<"query", "public", {
                today: string;
            }, Array<{
        ...
        points: {
            ...
            searchAssignmentsForLink: FunctionReference<"query", "public", {
                query: string;
            }, Array<{
                episode: {
                    id: Id<"episodes">;
        ...
        quotes: {
            ...
            getAdminReuseReport: FunctionReference<"query", "public", {
                id: Id<"quoteSubmissions">;
            }, {
                episodes: Array<{
                    episode: {
        ...
        seasons: {
            ...
            getPerformance: FunctionReference<"query", "public", {
                seasonId: Id<"seasons">;
            }, {
                points: Array<{
                    earnedAt: number;
    ...
    reviews: {
        admin: {
            ...
            getDeleteImpact: FunctionReference<"query", "public", {
                id: Id<"reviews">;
            }, {
    ...
    sideEffects: {
        intents: {
            list: FunctionReference<"query", "public", {
                ...
                status?: "pending" | "processing" | "retryScheduled" | "succeeded" | "terminal";
            }, {
                continueCursor: string;
                isDone: boolean;
                page: Array<{
                    ...
                    resourceId: string;
                    resourceType: "episodeAudioMessage" | "assignmentAudioMessage" | "profileImage";
                    status: "pending" | "processing" | "retryScheduled" | "succeeded" | "terminal";
                    updatedAt: number;
                }>;
                pageStatus?: "SplitRecommended" | "SplitRequired" | null;
            ...
            redrive: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
                expectedStatus: "pending" | "processing" | "retryScheduled" | "succeeded" | "terminal";
    ...
    syllabus: {
        admin: {
            ...
            reorderPendingForUser: FunctionReference<"mutation", "public", {
                clientApiVersion: string;
                items: Array<{
