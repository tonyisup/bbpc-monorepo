...
export type PublicApiType = {
  ...
  announcements: {
    admin: {
      ...
      >;
      endNow: FunctionReference<
        "mutation",
        "public",
        { clientApiVersion: string; id: Id<"announcements"> },
        {
          id: Id<"announcements">;
          message: string;
          severity: "info" | "warning";
  ...
  assignments: {
    admin: {
      ...
      >;
      updateIdentity: FunctionReference<
        "mutation",
        "public",
        {
          clientApiVersion: string;
  ...
  episodes: {
    transcripts: {
      inspect: FunctionReference<
        ...
        "public",
        { episodeId: Id<"episodes"> },
        { hash: string | null; number: number; title: string }
      >;
      remove: FunctionReference<
        "mutation",
        "public",
      ...
      replace: FunctionReference<
        ...
        "public",
        {
          ...
          passages: Array<{ end: number; start: number; text: string }>;
        },
        { changed: boolean; hash: string; passageCount: number }
      >;
  ...
  games: {
    ...
    guesses: {
      ...
      >;
      settleForAssignmentUser: FunctionReference<
        "mutation",
        "public",
        {
          assignmentId: Id<"assignments">;
      ...
      listForSeasonPage: FunctionReference<
        ...
        },
        {
          ...
          page: Array<{
            adjustment: number | null;
            earnedAt: number;
            episode: { id: Id<"episodes">; number: number; title: string } | null;
            gamePointType: {
              description: string | null;
              gameType: {
                description: string | null;
