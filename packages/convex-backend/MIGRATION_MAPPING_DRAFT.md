...
| `quoteSubmissions` | `by_episodeId`, `by_episodeId_and_status`, `by_episodeId_and_userId`, `by_episodeId_and_createdAt`, `by_episodeId_and_bracketOrder_and_createdAt`, `by_seasonId`, `by_userId`, `by_userId_and_createdAt`, `by_pointId`, plus the `search_quoteText` full-text search index |
